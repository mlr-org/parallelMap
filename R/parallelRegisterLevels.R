...
#'
#' @description
#' Package developers should call this function in their packages' [base::.onLoad()].
#' This enables the user to query available levels and bind parallelization to specific levels.
#' This is especially helpful for nested calls to [parallelMap()], e.g. where
...
#'   Available levels that are used in the [parallelMap()] operations of your package
#'   or code.
#'   If `package` is not missing, all levels will be prefixed with \dQuote{[package].}.
#' @return Nothing.
#' @export
...
#'   Default is `FALSE`.
#' @return [code{RegisteredLevels} | `character`]. See above.
#' @export
